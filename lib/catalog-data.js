...
// top sits at 9.3–9.5), so rating-sorted lists ignore them.
 ...
 *   { pseudo: 'this-year' }  or  { slug: 'comedy' }  or  null
 */
...
//   board:   shown on Stremio's Board by default; users turn rows off in the picker (Discover-only via a required genre extra)
...
//   derive:  DERIVED key – list computed from the union of all sources instead of one file
// ---------------------------------------------------------------------------
const CATALOG_DEFS = [
    ...
    { id: 'ncore-disneyplus-movies', type: 'movie', name: 'Disney+', source: 'disneyplus_movies', board: true, cache: 'latest', compact: true },
    { id: 'ncore-disneyplus-series', type: 'series', name: 'Disney+', source: 'disneyplus_series', board: true, cache: 'latest', compact: true },
    { id: 'ncore-prime-movies', type: 'movie', name: 'Prime Video', source: 'prime_movies', board: true, cache: 'latest', compact: true },
    { id: 'ncore-prime-series', type: 'series', name: 'Prime Video', source: 'prime_series', board: true, cache: 'latest', compact: true },
    { id: 'ncore-movies-top-seeded-magyar-filmek', type: 'movie', name: 'Top Seed · Magyar', source: 'most_seeded_hungarian_productions_movies', board: true, cache: 'topSeeded', compact: true },
    { id: 'ncore-series-top-seeded-magyar-sorozatok', type: 'series', name: 'Top Seed · Magyar', source: 'most_seeded_hungarian_productions_series', board: true, cache: 'topSeeded', compact: true },
    { id: 'ncore-top-downloaded-1080-movies', type: 'movie', name: 'Legtöbbet letöltött', source: 'top_downloaded_1080_movies', board: true, cache: 'topSeeded' },
    { id: 'ncore-top-downloaded-1080-series', type: 'series', name: 'Legtöbbet letöltött', source: 'top_downloaded_1080_series', board: true, cache: 'topSeeded' },
    { id: 'ncore-top-downloaded-1080-magyar-filmek', type: 'movie', name: 'Legtöbbet letöltött · Magyar', source: 'top_downloaded_1080_hungarian_productions_movies', board: true, cache: 'topSeeded', compact: true },
    { id: 'ncore-top-downloaded-1080-magyar-sorozatok', type: 'series', name: 'Legtöbbet letöltött · Magyar', source: 'top_downloaded_1080_hungarian_productions_series', board: true, cache: 'topSeeded', compact: true },
    { id: 'ncore-hd-movies-release-date', type: 'movie', name: 'Megjelenés éve', source: 'hd_movies', board: true, cache: 'latest', filter: 'year', sort: 'releaseYearDesc' },
    { id: 'ncore-hd-series-release-date', type: 'series', name: 'Megjelenés éve', source: 'hd_series', board: true, cache: 'latest', filter: 'year', sort: 'releaseYearDesc' },
    { id: 'ncore-classics-movies', type: 'movie', name: 'Klasszikusok', derive: 'classics', board: true, cache: 'derived', compact: true },
...
const DERIVED = {
    classics: (list) => list
        .filter(m => yearOf(m) !== null && yearOf(m) < 2000 && (ratingOf(m) || 0) >= 7 && (ratingOf(m) || 0) < MAX_CREDIBLE_RATING)
